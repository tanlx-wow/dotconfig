...
// @raycast.title Resize Front Window Up
// @raycast.mode silent
...
// Documentation:
// @raycast.description Resize the frontmost window to the top half of the current screen
...
let y = v.origin.y + margin * 2 + height // Top
