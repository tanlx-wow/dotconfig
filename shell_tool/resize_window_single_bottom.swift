...
// @raycast.title Resize Front Window Bottom
// @raycast.mode silent
...
// Documentation:
// @raycast.description Resize the frontmost window to the bottom half of the current screen
...
let height = (v.height - totalGapY) / 2
let x = v.origin.x + margin
let y = v.origin.y + margin // Bottom
