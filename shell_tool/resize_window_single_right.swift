...
// @raycast.title Resize Front Window Right
// @raycast.mode silent
...
// Documentation:
// @raycast.description Resize the frontmost window to the right half of the current screen
